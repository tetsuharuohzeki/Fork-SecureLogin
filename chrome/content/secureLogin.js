...
var secureLogin = {
	...
	getLoginFields: function(form, loginUsernameFieldName, loginPasswordFieldName) {
			...
			try {
			    ...
			    if(useJavaScriptProtection) {
			    	...
			    	function addToDataString(name, value) {
			    		...
			    		dataString += parentObject.urlEncode(name, charset)
			    					+ '='
			    					+ parentObject.urlEncode(value, charset);
			    	}
